        ...
        <div className="max-w-5xl mx-auto px-5 pt-5 pb-24">
            <div className="flex items-center justify-between mb-5">
                ...
                <button onClick={openAdd}
                    className="flex items-center gap-1.5 bg-lime text-[#000000] font-bold text-sm px-5 py-2.5 rounded-xl hover:shadow-[0_4px_20px_rgba(200,255,0,0.2)] transition-all active:scale-[0.97]">
                    <Plus size={15} /> Add
                </button>
            </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-1.5 mt-2">
                                    ...
                                    <button onClick={() => handleStock(p.id, 1)} className="w-6 h-6 rounded-md flex items-center justify-center bg-lime text-[#000000]">
                                        <ChevronUp size={12} />
                                    </button>
                                </div>
                            </div>
                        ...
                        <motion.div initial={{ y: '100%' }} animate={{ y: 0 }} exit={{ y: '100%' }}
                            ...
                            <div className="space-y-3.5">
                                ...
                                <button onClick={handleSave} disabled={isPending}
                                    className="w-full bg-lime text-[#000000] font-extrabold py-3.5 rounded-xl hover:shadow-[0_4px_20px_rgba(200,255,0,0.2)] transition-all active:scale-[0.97] disabled:opacity-40">
