                ...
                <div className="flex flex-col sm:flex-row gap-2.5">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={handleAdd} disabled={isPending}
                            className="flex items-center gap-1.5 bg-lime text-[#000000] font-bold px-5 py-2.5 rounded-xl hover:shadow-[0_4px_20px_rgba(200,255,0,0.2)] transition-all active:scale-[0.97] disabled:opacity-40">
